...
public class Inventory {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "book_inventory_generator")
    @SequenceGenerator(name="book_inventory_generator", sequenceName = "seq_inventory", allocationSize=1)
	long id;
