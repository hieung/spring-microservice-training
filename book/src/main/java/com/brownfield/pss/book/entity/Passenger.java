...
public class Passenger {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "book_passenger_generator")
    @SequenceGenerator(name="book_passenger_generator", sequenceName = "seq_passenger", allocationSize=1)
	long id;
