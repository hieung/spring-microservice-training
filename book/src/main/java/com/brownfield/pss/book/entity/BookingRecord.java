...
public class BookingRecord {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "book_bookingrecord_generator")
    @SequenceGenerator(name="book_bookingrecord_generator", sequenceName = "seq_bookingrecord", allocationSize=1)
	long id;
