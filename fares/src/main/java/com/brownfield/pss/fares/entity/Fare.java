...
public class Fare {
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "fares_fare_generator")
	@SequenceGenerator(name = "fares_fare_generator", sequenceName = "seq_fare", allocationSize=1)
	long id;
