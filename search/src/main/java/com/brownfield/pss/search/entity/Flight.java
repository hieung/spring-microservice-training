...
public class Flight {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "search_flight_generator")
   	@SequenceGenerator(name = "search_flight_generator", sequenceName = "seq_flight", allocationSize=1)
	long id;
